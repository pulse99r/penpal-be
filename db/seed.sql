...
VALUES
  ...
  ( 4,'Woman', 25, 'Quezon','Southern Tagalog','Phillippines', 'Slim', '{"5", "4"}', 'Brown', 'Black', 'Asian', 'No', 'Sometimes','Alone', '{"Drama","Comedy","SciFi", "True Crime"}', 'Christian', 'Single', 'No', 'Yes', 'Some College', 'Employed', 'Sales Associate', 'Funny', '{"Computers","Dancing","Cooking","Talking","Walking"}', '123-456-7890', 'Looking for Great PenPal!', 'Caring woman, enjoys getting to know people. I enjoy a siimple life.', 'Looking for a penpal who will write to me!', CURRENT_TIMESTAMP),
  ( 5,'Woman', 189, 'Cagayan','Northern Mindanao','Phillippines', 'Slim', '{"5", "0"}', 'Brown', 'Black', 'Asian', 'No', 'Sometimes','Alone', '{"Drama","Comedy","SciFi", "True Crime"}', 'Christian', 'Single', 'No', 'Yes', 'Some College', 'Employed', 'Sales Associate', 'Funny', '{"Computers","Dancing","Cooking","Talking","Walking"}', '123-456-7890', 'Looking for Great PenPal!', 'Caring woman, enjoys getting to know people. I enjoy a siimple life.', 'Looking for a penpal who will write to me!', CURRENT_TIMESTAMP);
